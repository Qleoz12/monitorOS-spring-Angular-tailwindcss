...
export class DriveService {
  ...
  {
    return this.get(this.endpointapi+"/drives");
  }

  getDriveInfo(drive:string): Observable<any>
  {
    return this.get(this.endpointapi+"/"+drive+"/info");
  }

  getFilesList(drive:string,path:string)
  {
    return this.get(this.endpointapi+"/"+drive+"/files");
  }
